...
import com.acn.manu.service.AllDepartmentsService;
...
public class AllDepartments extends HttpServlet {
    ...
    private AllDepartmentsService deptService;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        deptService= new AllDepartmentsService();
        listDept = deptService.allDept(em);
        
        RequestDispatcher rd=request.getRequestDispatcher("jsp/listDepartments.jsp");
